(function(factory) {
  ...
  _e(function(E, $) {
    ...
    // Preview 操作(马少博  2017年3月21日09:55:52 新增预览按钮)
    E.fn.preview = function() {

      var newhead = "<!DOCTYPE html><html><head><meta charset=\"UTF-8\"><title>文章预览</title><link href='http://cdn.bootcss.com/bootstrap/3.3.4/css/bootstrap.min.css' rel='stylesheet'><link href=\"static/common/frame/editor/wangEditor.css\" rel=\"stylesheet\" type=\"text/css\"><style>body{overflow:scroll;font-family:\"MicroSoft YaHei\";}  .close-btn{position:fixed;top:10px;right:10px;}</style></head><a class=\"btn btn-success btn-lg close-btn\" href=\"javascript:self.close()\" >关闭预览</a>";
      var htmlStr = "<div class='container'>" + editor.$txt.html() + "</div>";
      var newcontener = open("", "newcontener", 'width=' + (window.screen.availWidth - 10) + ',height=' + (window.screen.availHeight - 30) + ',top=0,left=0,status=no,menubar=yes,toolbar=no,scrollbars=yes');
      newcontener.document.open();
      newcontener.document.write(newhead + htmlStr);
      newcontener.document.close();
    };


    //修改图片上传到资源服务器
    E.fn.uploadToSource = function() {
  ...
  _e(function(E, $) {
    ...
    E.UI.menus = {
      ...
      //新增预览图标
      preview: {
        normal: '<a href="#" tabindex="-1"><i class="glyphicon glyphicon-eye-open"></i></a>',
        selected: '.selected'
      }
    };
  ...
  _e(function(E, $) {
    ...
    E.createMenu(function(check) {
      ...
      // 上传图片 操作(马少博  2017年3月23日09:55:52 新增按钮)
      menu.clickEvent = function(e) {
        e.preventDefault();
        tool.openModal(null, null, '', 1, 'showImage');
      };
      // 增加到editor对象中
      editor.menus[menuId] = menu;
    });
  ...
  _e(function(E, $) {
    ...
    E.createMenu(function(check) {
      ...
      // Preview 操作(马少博  2017年3月21日09:55:52 新增按钮)
      menu.clickEvent = function(e) {
        editor.preview(); //TODO
      };
